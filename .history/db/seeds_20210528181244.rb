...
all_bios = ["Huge Sneakerhead", "I love shoes", "Please don't touch my raf", "Yeezy taught me"]
...
good_description = ["worn", "Lots of life left", "Great shoe" "best release of the year", "Lots of life left in it", "awesome shoe", "Doubled up on these", "fire on foot", "sheeeeesh", "Absolute gas", "My favorite colorway", "banger of a shoe", "gas", "incredible shoe", "even better in person", "fire in person", "fits perfect", "sick af"]
...
shit_description = ["nasty", "still has life in it", "wearable", "i'll die in these shoes", "never tossing these", "still fly", "Got life in em", "HEAT", "Crazy on foot", "crepe of the year", "got em for a steal", "Foun at Goodwill", "wow nasty", "skateable", "gaspack", "Jesus Christ", "Fire AF", "DAMN these nice", "My dress shoes", "Perfect for a date or the club", "Formal but ready to party", "fly af", "Beat as shit", "NASTY",  "Wtf was I thinking", "God's shoes", "fire emoji gas emoji", "sheeeeeeeeeeeeeeeesh", "Absolute Heaters" ] 
