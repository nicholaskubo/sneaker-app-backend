...
all_bios = ["TIP TOEIN IN MY JORDANS", "Bands, bands, bands", "ice on me ", "SNEAKERS R LIFE", "I <3 kicks", "Please don't touch my raf", "Yeezy taught me", "don't tell my wife", "R.I.P. Kobe", "Fashion Killa", "Goat", "It's Lit", "Sneaker Plug", "kING VAMP", "slat", "rIP mF dOOM !", "Got more kicks than friends", "Baller on a budget", "Simple Fits", "Anything for the fit", "HIT MY LINE FOR ALL NEW RELEASES"]
