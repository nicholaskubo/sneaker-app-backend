...
# descriptions
deadstock = ["DSWT", "BRAND NEW", "had to get one to rock and one to stock", "New with tags", "bought the wrong size", "Fresh af", "STAIGHT FROM THE FACTORY", "new w/ tags", "CRISPY", "Deadstock", "Unworn", "Super comfortable", "look great in person", "Fire", "sick", "dope", "never even opened the box", "Slight dent on box", "Great material", "Great shoe", "flawless condition", "crazy shoe", "fire", "BEST colorway"]
