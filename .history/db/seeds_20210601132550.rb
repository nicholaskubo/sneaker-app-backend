...
comments = ["So sick", "I wanna be burried in these", "I'd kill my child for this pair", "Crazy Details", "fire", "can't believe I slept on these", "what are those?!", "link?", "these from last year?", "Crazy design on these", "Wish I copped", "God damn I slept on these", "these ugly af", "I wouldn't let my worst enemy step out in these", "these aint it fam", "trash", "What were you thinking?" "fucking flames", "DAMN", "Ok!", "yo lemme cop", "How much you want for em?", "I need these", "wet", "damn son", "how's the material", "hows the fit?", "Are these true to size?", "I'll take", "lemmee get these boss", "I'll pickup rn", "hella fakes of these", "Not sure if these fit me well. Can i try them on first?", "Love the material on these", "I got these in a purple", "You always got the best kicks", "Damn bruh these hard", "always with the heat", "Damn, I didnt hit on the raffle", "You're my idol bro", "I'm still looking for these", "these were a insta cop", "I'd hang these on the wall like some art", "If I could afford these I couldn't get myself to wear em. Crazy heat", "I wanna get burried in these", "Lemme have em lmao", "lemme borrow these boss!", "best collection on this site, no cap", "Best shoe of the year no cap", "insane deatils", "didn't these go on sale?", "Howd you gettem??", "were these limited?", "whats resale?", "how much these go for now?", "damn i had a chance to cop for retail. heat!", "would you ship to Denmark?", "trade for a PS3?", "yo trade for my ipod nano?", "you interested in trades?", "lemme know when you have a price", "people forsure slept on these", "ugly af", "where would you actually where these?", "you get these online?", "salty i couldnt cop", "where did u buy?", "these are staple in my rotation", "some grails right here", "Great everyday pair", "drip", "wet", "fire", "get em legit checked, tons of fakes", "insole moves around on this pair, hella annoying", "materials were better on the last model"]
