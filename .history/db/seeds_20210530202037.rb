...
3.times do
    Like.create(user_id: User.all.sample.id , user_shoe_id: UserShoe.all.sample.id)
end 

puts "loads comments"

3.times do
    Comment.create(user_id: User.all.sample.id, user_shoe_id: UserShoe.all.sample.id, content: "Hey")
end 