...
all_bios = ["Huge Sneakerhead", "I love shoes", "SNEAKER R LIFE", "I <3 kicks", "Please don't touch my raf", "Yeezy taught me", "don't tell my wife", "R.I.P. Kobe", "Fashion Killa", "Goat", "It's Lit", "Sneaker Plug", "kING VAMP", "slat", "rIP mF dOOM ! wTF", "Got more kicks than friends", "Baller on a budget", "Simple Fits", "Anything for the fit"]
...
40.times do 
    User.create(username: Faker::FunnyName.unique.name, password: "password", image: Faker::Avatar.unique.image, bio: all_bios.sample)
end
